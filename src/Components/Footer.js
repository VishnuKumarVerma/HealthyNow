    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            ...
            <li>
              <a href="tel:+022 5454 5252">+123 454 321</a>
            </li>
            <li>
              <a href="tel:+022 2326 6232">+099 672 678</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="ft-copyright">
        ...
        <ul className="ft-social-links">
          ...
          <li>
            <a
              href="https://www.facebook.com/vishnukumar.verma.5268/"
              title="FaceBook"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <li>
            <a
              href="https://x.com/vishnu_kr_verma"
              title="Twitter"
              target="_blank"
              rel="noopener noreferrer"
            >
